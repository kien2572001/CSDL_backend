...
let initWebRoutes = (app) => {
  ...
  router.get(
    ...
    productController.handleGetCategoryById
  );
  ...
  router.post(
    "/api/save-to-order-item",
    productController.handleSaveToOrderItem
  );
  router.get("/api/find-order-by-id", productController.handleFindOrderById);
  router.get(
    "/api/find-product-by-id",
    productController.handleFindProductById
  );
  router.get(
    "/api/find-order-by-userid",
    userController.handleFindOrderByUserId
  );
  ...
  router.post(
    "/api/change-fla",
    userController.handleChangeFirstNameLastNameAvatar
  );
  ...
  router.get(
    "/api/admin/get-order-by-sid",
    adminController.handleGetOrderBySid
  );
  router.get(
    "/api/get-order-item-by-sid-orderid",
    adminController.handleGetOrderItemBySidAndOrderId
  );
  router.post(
    "/api/change-order-status",
    adminController.handleChangeOrderStatus
  );
  router.get("/api/get-product-by-sid", adminController.handleGetProductBySid);
  router.post(
    "/api/add-new-product-by-store",
    adminController.handleAddNewProductByStore
  );
  router.get("/api/get-next-pid", adminController.handleGetNextPid);
  router.post(
    "/api/add-product-category",
    adminController.handleAddProductCategory
  );
  router.post(
    "/api/update-product-by-store",
    adminController.handleUpdateProductByStore
  );
  ...
  //product
  router.get(
    "/api/get-product-by-storeId",
    productController.handleGetProductByStoreId
  );
  router.post(
    "/api/delete-product-by-pid",
    productController.handleDeleteProductById
  );
  router.get("/api/search-by-name", productController.handleGetProductByName);
